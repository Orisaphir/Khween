...
module.exports = {
    ...
    async run(client, message, args) {
        ...
        return message.reply(success ? {content: `Je reprend la lecture de ${queue.current.title} !`, ephemeral: true} : {content: `J'ai eu un soucis lors de la reprise !`, ephemeral: true});
    },
};